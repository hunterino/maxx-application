package twohtwo.maxx.application.repository;

import twohtwo.maxx.application.MaxxApplicationApp;
import twohtwo.maxx.application.config.Constants;
import twohtwo.maxx.application.config.audit.AuditEventConverter;
import twohtwo.maxx.application.domain.PersistentAuditEvent;
...
import static twohtwo.maxx.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
